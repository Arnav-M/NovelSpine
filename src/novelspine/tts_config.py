...
EDGE_CHUNK_PARALLEL = int(os.environ.get("NOVELSPINE_EDGE_CHUNK_PARALLEL", "6"))
SECTION_PARALLEL = int(os.environ.get("NOVELSPINE_SECTION_PARALLEL", "4"))


def resolve_engine(engine: str) -> str:
    """Resolve engine aliases. NovelSpine currently narrates with Edge only."""
    return "edge"
