...
from novelspine.gui_theme import (
    apply_theme,
    attach_tooltip,
...
from novelspine.gui_audiobook_tab import (
    _SECTION_PRESET_DEFAULT,
    _SECTION_PRESETS,
    AudiobookTabMixin,
)
from novelspine.gui_document_tab import DocumentTabMixin
from novelspine.gui_jobs import JobRunner
from novelspine.gui_player_tab import (
    _PLAYER_CHAPTER_SUB_PLACEHOLDER,
    _PLAYER_CHAPTER_TITLE_PLACEHOLDER,
    PlayerTabMixin,
)
from novelspine.gui_settings import SettingsMixin
from novelspine.player import AudioPlayer
...
class NovelSpineApp(DocumentTabMixin, AudiobookTabMixin, PlayerTabMixin, SettingsMixin, tk.Tk):
    def __init__(self) -> None:
        super().__init__()
        self.title("NovelSpine")
        self._busy = False
        self._pulse_step = 0
    ...
    def _sync_form_control_sizes(self) -> None:
        ...
        from novelspine.tts_voices import voices_for_engine
    ...
    def _build_hero(self, parent: ttk.Frame) -> None:
        ...
        kicker = tk.Label(text_col, text="NovelSpine", bg=hero_bg, fg=self.colors["hero_kicker"], anchor="w")
    ...
    def _prefs_file(self) -> Path:
        from novelspine.user_paths import user_data_dir
