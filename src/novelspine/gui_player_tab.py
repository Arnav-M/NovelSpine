"""Player tab for the NovelSpine GUI.

Library picker, transport controls, chapter/book timelines, playback speed,
volume, and resume persistence. Mixed into NovelSpineApp (see gui.py).
"""
...
from novelspine.book_structure import find_cover_image_path
from novelspine.cover_art import clear_cover_photo_cache, find_cover_for_audiobook, load_cover_photo
...
from novelspine.player import is_pygame_playable, scan_audiobook_folder
...
class PlayerTabMixin:
    ...
    def _probe_missing_durations_async(self, chapters: list) -> None:
        ...
        def work() -> None:
            from novelspine.player import probe_chapter_durations
    ...
    def _prune_speed_cache_async(self) -> None:
        def work() -> None:
            from novelspine.player import prune_speed_cache
    ...
    def _play_index(self, index: int, start_fraction: float = 0.0) -> bool:
        ...
        from novelspine.player import cached_speed_variant, make_speed_variant
