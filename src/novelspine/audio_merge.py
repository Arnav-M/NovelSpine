...
from novelspine.ffmpeg_path import find_ffmpeg, find_ffprobe

AAC_BITRATE = os.environ.get("NOVELSPINE_AAC_BITRATE", "64k")
    ...
    *,
    ...
    if not ffmpeg:
        raise RuntimeError(
            ...
            "Install ffmpeg or reinstall NovelSpine with bundled ffmpeg."
        )
